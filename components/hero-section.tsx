                    ...
                    >
                        ...
                        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                            <Button
                                size="lg"
                                variant="outline"
                                // Classes added for text color based on theme:
                                className="glass-panel bg-transparent backdrop-blur-md shadow-md hover:shadow-lg text-black dark:text-gray-200"
                                asChild
                            >
